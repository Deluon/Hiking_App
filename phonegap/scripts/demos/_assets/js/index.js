...
$.fn.viewSourceCode = function() {
	return $( this ).each( function() {
		...
		if ( self.is( "[data-demo-jquery]" ) ) {
			data = getSnippet( "script", self.attr( "data-demo-jquery" ), snippetSource );
			sources.push( { title: "JS", theme: "e", brush: "jquery", data: fixData( data ) } );
		}
...
$( document ).on( "pagebeforecreate", "[data-role='page']", function() {
	$( this ).find( "[data-demo-html], [data-demo-jquery], [data-demo-css], [data-demo-php]" ).viewSourceCode();
...
$( document ).on( "pagecreate", function( e ) {
	...
	// reposition when switching between html / jquery / css
...
;(function()
{
	...
	Brush.prototype	= new SyntaxHighlighter.Highlighter();
	Brush.aliases	= ['jquery', 'jscript', 'javascript'];
